          ...
          <div>
            <div class="mt-3 flex justify-between pt-1 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="flex w-full justify-end">
                <span :class="[icomoonCrossIconSrc, icomoonCrossIconStyle]" @click="$emit('cancel')"></span>
              </div>
            </div>

            <div v-if="canBeDeleted" class="w-full justify-center pt-16 mb-24">
             <span :class="alertIcon"></span>
             <div class="flex w-full justify-center text-center">
               <div :class="titleDeleteStyle">
                 {{ titleDelete }}
               </div>
             </div>
            ...
            <div v-else class="w-full flex flex-col justify-center">
              <span :class="alertIcon"></span>
              <div class="flex w-full justify-center text-center">
                <div :class="titleNoDeleteStyle">
                  {{ titleNoDelete }}
                </div>
              </div>
              <div>
                <div :class="subTitleNoDeleteStyle">
                  {{ subTitleNoDelete }}
                </div>
              </div>


              <div :class="errorsContainerStyle">
                <div v-for="(error, index) in errors" :key="index" class="mb-4">
                  ...
                  <div class="flex">
                    ...
                    <div v-show="error.date" :class="createdOnStyle">
                      {{ createdOnLabel }}
                    </div>
